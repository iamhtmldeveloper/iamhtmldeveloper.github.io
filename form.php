...
if ($_SERVER["REQUEST_METHOD"] == "POST" && Form::testToken('validation-with-jquery-example-form') === true) {
    ...
    if ($validator->hasErrors()) {
        ...
        $email_config = array(
            'sender_email'    => 'anmolhtmldeveloper@gmail.com',
...
$form = new Form('validation-with-jquery-example-form', 'horizontal', 'novalidate');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create form with jQuery live validation using Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-4-forms/validation-with-jquery-example-form.php" />
